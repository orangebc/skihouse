	...
	<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  		...
  		<div class="carousel-inner" role="listbox">
    		<div class="item active">
      		<img src="images/squawvalley/slider1.jpg" alt="Carousel-item">
      			<div class="container">
	      			<div class="carousel-caption">
						<h1 class="generic__title--white minisite__slider--caption">Descubre <br> todo lo que <br> <small>Squaw Valley tiene para ti</small></h1>
						<h6 class="minisite__weather"></h6>
	      			</div>
      			</div>
    		</div>
    		<div class="item">
      		<img src="images/squawvalley/slider2.jpg" alt="Carousel-item">
      			<div class="container">
      				<div class="carousel-caption">
						<h1 class="generic__title--white minisite__slider--caption">Descubre <br> todo lo que <br> <small>Squaw Valley tiene para ti</small></h1>
						<h6 class="minisite__weather"></h6>
    		...
    		<div class="item">
      		<img src="images/squawvalley/slider3.jpg" alt="Carousel-item">
      			<div class="container">
      				<div class="carousel-caption">
						<h1 class="generic__title--white minisite__slider--caption">Descubre <br> todo lo que <br> <small>Squaw Valley tiene para ti</small></h1>
						<h6 class="minisite__weather"></h6>
    		...
    		<div class="item">
      		<img src="images/squawvalley/slider4.jpg" alt="Carousel-item">
      			<div class="container">
      				<div class="carousel-caption">
						<h1 class="generic__title--white minisite__slider--caption">Descubre <br> todo lo que <br> <small>Squaw Valley tiene para ti</small></h1>
						<h6 class="minisite__weather"></h6>
...
<!-- squawValley -->
	<div class="text-center">
    	...
    	<h2 class="red__section--title">Squaw Valley</h2>
    </div>
<!-- /squawValley -->
<!-- minisiteAbout -->
	...
	<div class="container-fluid no-space">
		<div class="col-lg-6 no-space">
			<div class="minisite__about--content">
				...
				<p class="minisite__about--info">Squaw Valley es un renombrado ski resort en North Lake, California. Cuenta con 42 lifts y 270 pistas así como una villa inspirada en Europa que cuenta con casi 60 restaurantes, bares, boutiques y galerías de arte. Anualmente tiene aproximadamente 450 pulgadas de nieve, y cuenta con las temporadas más largas de nieve. </p>
			</div>
		</div>
		<div class="col-lg-6 no-space">
			<div class="minisite__about--activities">
				...
				<ul class="list-inline minisite__about--icons">
					<li>
						<img src="images/squawvalley/actividades/actv1.png" alt="Actividades">
						<span>Ice Skating</span>
					</li>
					<li>
						<img src="images/squawvalley/actividades/actv2.png" alt="Actividades">
						<span>Dog Sledding</span>
					</li>
					<li>
						<img src="images/squawvalley/actividades/actv3.png" alt="Actividades">
						<span>Cross Country Skiing</span>
					</li>
					<li>
						<img src="images/squawvalley/actividades/actv4.png" alt="Actividades">
						<span>Olympic Museum</span>
					</li>
					<li>
						<img src="images/squawvalley/actividades/actv5.png" alt="Actividades">
						<span>Scenic Gondola Rides</span>
					</li>
					<li>
						<img src="images/squawvalley/actividades/actv6.png" alt="Actividades">
						<span>Ski Jump</span>
					</li>
				</ul>
			</div>
...
<section class="minisite__for">
	...
	<div class="container-fluid no-space">
		<div class="col-lg-3 no-space">
			...
			<img src="images/squawvalley/ideal1.jpg" alt="Ideal">
		...
		<div class="col-lg-3 no-space">
			<figure class="minisite__for--item">
			<img src="images/squawvalley/ideal2.jpg" alt="Ideal">
				<figcaption class="minisite__for--item-name">
					<h6>Jóvenes</h6>
				</figcaption>
			</figure>
		...
		<div class="col-lg-3 no-space">
			<figure class="minisite__for--item">
			<img src="images/squawvalley/ideal3.jpg" alt="Ideal">
				<figcaption class="minisite__for--item-name">
					<h6>Familias</h6>
				</figcaption>
			</figure>
		...
		<div class="col-lg-3 no-space">
			<figure class="minisite__for--item">
			<img src="images/squawvalley/ideal4.jpg" alt="Ideal">
				<figcaption class="minisite__for--item-name">
					<h6>Skiadores</h6>
				</figcaption>
			</figure>
...
<section class="minisite__hotels">
	...
	<div id="carousel2" class="carousel slide" data-ride="carousel">
  		...
  		<div class="carousel-inner" role="listbox">
    		<div class="item active">
      		<img src="images/squawvalley/slideh1.jpg" alt="Carousel-item">
      			<div class="container">
	      			<div class="carousel-caption">
	        			<h2 class="minisites__hotels--name">Plumpjack Squawvalley Inn</h2>
	      			</div>
      			</div>
    		</div>
    		<div class="item">
      		<img src="images/squawvalley/slideh2.jpg" alt="Carousel-item">
      			<div class="container">
      				<div class="carousel-caption">
      					<h2 class="minisites__hotels--name">Squaw Creek</h2>
      				</div>
        		</div>
        	</div>
    		<div class="item">
      		<img src="images/squawvalley/slideh3.jpg" alt="Carousel-item">
      			<div class="container">
      				<div class="carousel-caption">
      					<h2 class="minisites__hotels--name">Squaw Valley Lodge</h2>
      				</div>
        		</div>
        	</div>
     	</div>
...
<!-- /minisiteMountain -->
	<div class="container-fluid no-space">
		...
		<div class="col-lg-6 no-space">
			<a href="images/squawvalley/info-montana.pdf" download="infoMontanaSquawValley"><h5 class="minisite__mountain--download">Descargar Información de la Montaña</h5></a>
		</div>
	</div>
	...
	<div class="container-fluid">
		<div class="col-lg-3">
			<article class="minisite__resort--item">
				...
				<h6 class="minisite__resort--item-name"><a href="http://www.squawalpine.com">www.squawalpine.com</a></h6>
			</article>
		</div>
		<div class="col-lg-3">
			<article class="minisite__resort--item">
				...
				<h6 class="minisite__resort--item-name">1960 Squaw Valley Rd, Olympic Valley, <br> CA 96146, Estados Unidos</h6>
			</article>
		</div>
		<div class="col-lg-3">
			<article class="minisite__resort--item">
				...
				<h6 class="minisite__resort--item-name">Phone: <br> +1 530-452-4331</h6>
			</article>
		</div>
		<div class="col-lg-3">
			<article class="minisite__resort--item">
				...
				<h6 class="minisite__resort--item-name">info@squawalpine.com</h6>
			</article>
		</div>
	</div>
