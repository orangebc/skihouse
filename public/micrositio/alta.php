	...
	<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  		...
  		<div class="carousel-inner" role="listbox">
    		<div class="item active">
      		<img src="images/alta/slider1.jpg" alt="Carousel-item">
      			<div class="container">
	      			<div class="carousel-caption">
						<h1 class="generic__title--white minisite__slider--caption">No hay mejor <br> lugar que <br> <small>Alta para ti</small></h1>
						<h6 class="minisite__weather"></h6>
	      			</div>
      			</div>
    		</div>
    		<div class="item">
      		<img src="images/alta/slider2.jpg" alt="Carousel-item">
      			<div class="container">
      				<div class="carousel-caption">
						<h1 class="generic__title--white minisite__slider--caption">No hay mejor <br> lugar que <br> <small>Alta para ti</small></h1>
						<h6 class="minisite__weather"></h6>
    		...
    		<div class="item">
      		<img src="images/alta/slider3.jpg" alt="Carousel-item">
      			<div class="container">
      				<div class="carousel-caption">
						<h1 class="generic__title--white minisite__slider--caption">No hay mejor <br> lugar que <br> <small>Alta para ti</small></h1>
						<h6 class="minisite__weather"></h6>
    		...
    		<div class="item">
      		<img src="images/alta/slider4.jpg" alt="Carousel-item">
      			<div class="container">
      				<div class="carousel-caption">
						<h1 class="generic__title--white minisite__slider--caption">No hay mejor <br> lugar que <br> <small>Alta para ti</small></h1>
						<h6 class="minisite__weather"></h6>
...
<!-- altaMinisite -->
	<div class="text-center">
    	...
    	<h2 class="red__section--titleSmall">Alta</h2>
    </div>
<!-- /altaMinisite -->
<!-- minisiteAbout -->
	...
	<div class="container-fluid no-space">
		<div class="col-lg-6 no-space">
			<div class="minisite__about--content">
				...
				<p class="minisite__about--info">El área de Ski Alta es reconocida a nivel mundial por tener excelente nieve combinada con el terreno más diverso y desafiante de Norteamérica.</p>
				<p class="minisite__about--info" style="padding-top:0;">Está localizada a poco más de un kilómetro de Snowbird en el Cañon de Little Cottonwood, con aproximadamente 890 hectáreas de terreno esquiable y un promedio de 560 pulgadas de nieve cada estación.</p>
				<p class="minisite__about--info" style="padding-top:0;">Es una de las estaciones de esquí más antiguas en Estados Unidos y ha traído a muchos viajeros desde 1933. El acceso es solamente para esquiadores.</p>
			</div>
		</div>
		<div class="col-lg-6 no-space">
			<div class="minisite__about--activities">
				...
				<ul class="list-inline minisite__about--icons">
					<li>
						<img src="images/alta/actividades/actv1.png" alt="Actividades">
						<span>Cross Country Skiing</span>
					</li>
					<li>
						<img src="images/alta/actividades/actv2.png" alt="Actividades">
						<span>Snowcat Skiing</span>
					</li>
					<li>
						<img src="images/alta/actividades/actv3.png" alt="Actividades">
						<span>Snowshoeing</span>
					</li>
					<li>
						<img src="images/alta/actividades/actv4.png" alt="Actividades">
						<span>Snowbiking</span>
					</li>
					<li>
						<img src="images/alta/actividades/actv5.png" alt="Actividades">
...
<section class="minisite__for">
	...
	<div class="container-fluid no-space">
		...
		<div class="col-lg-3 no-space">
			<figure class="minisite__for--item">
			<img src="images/alta/ideal4.jpg" alt="Ideal">
				<figcaption class="minisite__for--item-name">
					<h6>Amigos</h6>
				</figcaption>
			</figure>
  		...
  		<div class="carousel-inner" role="listbox">
    		<div class="item active">
      		<img src="images/alta/slideh1.jpg" alt="Carousel-item">
      			<div class="container">
	      			<div class="carousel-caption">
	        			<h2 class="minisites__hotels--name">Alta Peruvian Lodge</h2>
	      			</div>
      			</div>
    		</div>
    		<div class="item">
      		<img src="images/alta/slideh2.jpg" alt="Carousel-item">
      			<div class="container">
      				<div class="carousel-caption">
      					<h2 class="minisites__hotels--name">Alta’s Rustler Lodge</h2>
      				</div>
        		</div>
        	</div>
    		<div class="item">
      		<img src="images/alta/slideh3.jpg" alt="Carousel-item">
      			<div class="container">
      				<div class="carousel-caption">
      					<h2 class="minisites__hotels--name">Solitude Resorts and Lodging</h2>
      				</div>
        		</div>
        	</div>
    		<div class="item">
...
<section class="minisite__mountain">
	<div class="container-fluid">
		<ul class="list-inline minisite__mountain--items">
			...
			<li>
				<span class="minisite__mountain--details">890.30 ha.</span>
				<hr class="minisite__mountain--separator">
				<span class="minisite__mountain--data">Terreno esquiable</span>
			</li>
			<li>
				<span class="minisite__mountain--details">1.61 km</span>
				<hr class="minisite__mountain--separator">
...
<!-- /minisiteMountain -->
	<div class="container-fluid no-space">
		...
		<div class="col-lg-6 no-space">
			<a href="images/alta/info-montana.pdf" download="infoMontanaAlta"><h5 class="minisite__mountain--download">Descargar Información de la Montaña</h5></a>
		</div>
	</div>
	...
	<div class="container-fluid">
		<div class="col-lg-3">
			<article class="minisite__resort--item">
				...
				<h6 class="minisite__resort--item-name"><a href="http://www.discoveralta.com">www.discoveralta.com</a></h6>
			</article>
		</div>
		<div class="col-lg-3">
			<article class="minisite__resort--item">
				...
				<h6 class="minisite__resort--item-name">P.O. Box 8007<br> Alta, Utah 84092</h6>
			</article>
		</div>
		<div class="col-lg-3">
			<article class="minisite__resort--item">
				...
				<h6 class="minisite__resort--item-name">Phone: <br> 1 (888) 782-9258</h6>
			</article>
		</div>
		<div class="col-lg-3">
			<article class="minisite__resort--item">
				...
				<h6 class="minisite__resort--item-name">info@alta.com</h6>
			</article>
		</div>
	</div>
