	...
	<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  		...
  		<div class="carousel-inner" role="listbox">
    		<div class="item active">
      		<img src="images/deervalley/slider1.jpg" alt="Carousel-item">
      			<div class="container">
	      			<div class="carousel-caption">
						<h1 class="generic__title--white minisite__slider--caption">Disfruta de la <br> mejor experiencia <br> <small>que Deer Valley ofrece</small></h1>
						<h6 class="minisite__weather"></h6>
	      			</div>
      			</div>
    		</div>
    		<div class="item">
      		<img src="images/deervalley/slider2.jpg" alt="Carousel-item">
      			<div class="container">
      				<div class="carousel-caption">
						<h1 class="generic__title--white minisite__slider--caption">Disfruta de la <br> mejor experiencia <br> <small>que Deer Valley ofrece</small></h1>
						<h6 class="minisite__weather"></h6>
    		...
    		<div class="item">
      		<img src="images/deervalley/slider3.jpg" alt="Carousel-item">
      			<div class="container">
      				<div class="carousel-caption">
						<h1 class="generic__title--white minisite__slider--caption">Disfruta de la <br> mejor experiencia <br> <small>que Deer Valley ofrece</small></h1>
						<h6 class="minisite__weather"></h6>
    		...
    		<div class="item">
      		<img src="images/deervalley/slider4.jpg" alt="Carousel-item">
      			<div class="container">
      				<div class="carousel-caption">
						<h1 class="generic__title--white minisite__slider--caption">Disfruta de la <br> mejor experiencia <br> <small>que Deer Valley ofrece</small></h1>
						<h6 class="minisite__weather"></h6>
...
$(document).ready(function() {
  $.simpleWeather({
    location: 'Deer Valley Resort, UT, USA',
    woeid: '',
    unit: 'c',
...
<!-- deerValleyMinisite -->
	<div class="text-center">
    	...
    	<h2 class="red__section--title">Deer Valley</h2>
    </div>
<!-- /deerValleyMinisite -->
<!-- minisiteAbout -->
	...
	<div class="container-fluid no-space">
		<div class="col-lg-6 no-space">
			<div class="minisite__about--content">
				...
				<p class="minisite__about--info">Deer Valley Resort es una estación de esquí alpino en la cordillera Wasatch, situado a 36 millas (58 km) al este de Salt Lake City, en Park City, Utah, Estados Unidos. El complejo, conocido por sus servicios de alta calidad, es constantemente clasificada entre las mejores estaciones de esquí en América del Norte.</p>
			</div>
		</div>
		<div class="col-lg-6 no-space">
			<div class="minisite__about--activities">
				...
				<ul class="list-inline minisite__about--icons">
					<li>
						<img src="images/deervalley/actividades/actv1.png" alt="Actividades">
						<span>Snowmobile Tours</span>
					</li>
					<li>
						<img src="images/deervalley/actividades/actv2.png" alt="Actividades">
						<span>Heli-skiing</span>
					</li>
					<li>
						<img src="images/deervalley/actividades/actv3.png" alt="Actividades">
						<span>Hot Air Balloon</span>
					</li>
					<li>
						<img src="images/deervalley/actividades/actv4.png" alt="Actividades">
...
<section class="minisite__for">
	...
	<div class="container-fluid no-space">
		<div class="col-lg-3 no-space">
			...
			<img src="images/deervalley/ideal1.jpg" alt="Ideal">
		...
		<div class="col-lg-3 no-space">
			<figure class="minisite__for--item">
			<img src="images/deervalley/ideal2.jpg" alt="Ideal">
				<figcaption class="minisite__for--item-name">
					<h6>Deportistas</h6>
				</figcaption>
			</figure>
		...
		<div class="col-lg-3 no-space">
			<figure class="minisite__for--item">
			<img src="images/deervalley/ideal3.jpg" alt="Ideal">
				<figcaption class="minisite__for--item-name">
					<h6>Familias</h6>
				</figcaption>
			</figure>
		...
		<div class="col-lg-3 no-space">
			<figure class="minisite__for--item">
			<img src="images/deervalley/ideal4.jpg" alt="Ideal">
				<figcaption class="minisite__for--item-name">
					<h6>Jóvenes</h6>
				</figcaption>
			</figure>
...
<section class="minisite__hotels">
	...
	<div id="carousel2" class="carousel slide" data-ride="carousel">
  		...
  		<div class="carousel-inner" role="listbox">
    		<div class="item active">
      		<img src="images/deervalley/slideh1.jpg" alt="Carousel-item">
      			<div class="container">
	      			<div class="carousel-caption">
	        			<h2 class="minisites__hotels--name">Montage</h2>
	      			</div>
      			</div>
    		</div>
    		<div class="item">
      		<img src="images/deervalley/slideh2.jpg" alt="Carousel-item">
      			<div class="container">
      				<div class="carousel-caption">
      					<h2 class="minisites__hotels--name">St Regis</h2>
      				</div>
        		</div>
        	</div>
    		<div class="item">
      		<img src="images/deervalley/slideh3.jpg" alt="Carousel-item">
      			<div class="container">
      				<div class="carousel-caption">
      					<h2 class="minisites__hotels--name">Stein Eriksen</h2>
      				</div>
        		</div>
        	</div>
    		<div class="item">
      		<img src="images/deervalley/slideh4.jpg" alt="Carousel-item">
      			<div class="container">
      				<div class="carousel-caption">
      					<h2 class="minisites__hotels--name">The Chateaux</h2>
      				</div>
        		</div>
        	</div>
     	</div>
...
<!-- /minisiteMountain -->
	<div class="container-fluid no-space">
		...
		<div class="col-lg-6 no-space">
			<a href="images/deervalley/info-montana.pdf" download="infoMontanaDeerValley"><h5 class="minisite__mountain--download">Descargar Información de la Montaña</h5></a>
		</div>
	</div>
		...
		<div class="container">
			<div class="col-lg-4">
				<article class="minisite__mountain-icons--item">
					...
					<span class="minisite__mountain-icons-x">26%</span>
	...
	<div class="container-fluid">
		<div class="col-lg-3">
			<article class="minisite__resort--item">
				...
				<h6 class="minisite__resort--item-name"><a href="http://www.deervalley.com">www.deervalley.com</a></h6>
			</article>
		</div>
		<div class="col-lg-3">
			<article class="minisite__resort--item">
				...
				<h6 class="minisite__resort--item-name">2250 Deer Valley Dr S, Park City,<br> UT 84060, Estados Unidos</h6>
			</article>
		</div>
		<div class="col-lg-3">
			<article class="minisite__resort--item">
				...
				<h6 class="minisite__resort--item-name">Phone: <br> +1 435-649-1000</h6>
			</article>
		</div>
		<div class="col-lg-3">
			<article class="minisite__resort--item">
				...
				<h6 class="minisite__resort--item-name">emarketing@deervalley.com</h6>
			</article>
		</div>
	</div>
