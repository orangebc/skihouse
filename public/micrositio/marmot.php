	...
	<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  		...
  		<div class="carousel-inner" role="listbox">
    		<div class="item active">
      		<img src="images/marmot/slider1.jpg" alt="Carousel-item">
      			<div class="container">
	      			<div class="carousel-caption">
						<h1 class="generic__title--white minisite__slider--caption">Los momentos<br> más increíbles <br> <small>Vívelos en Marmot</small></h1>
						<h6 class="minisite__weather"></h6>
	      			</div>
      			</div>
    		</div>
    		<div class="item">
      		<img src="images/marmot/slider2.jpg" alt="Carousel-item">
      			<div class="container">
      				<div class="carousel-caption">
						<h1 class="generic__title--white minisite__slider--caption">Los momentos<br> más increíbles <br> <small>Vívelos en Marmot</small></h1>
						<h6 class="minisite__weather"></h6>
    		...
    		<div class="item">
      		<img src="images/marmot/slider3.jpg" alt="Carousel-item">
      			<div class="container">
      				<div class="carousel-caption">
						<h1 class="generic__title--white minisite__slider--caption">Los momentos<br> más increíbles <br> <small>Vívelos en Marmot</small></h1>
						<h6 class="minisite__weather"></h6>
    		...
    		<div class="item">
      		<img src="images/marmot/slider4.jpg" alt="Carousel-item">
      			<div class="container">
      				<div class="carousel-caption">
						<h1 class="generic__title--white minisite__slider--caption">Los momentos<br> más increíbles <br> <small>Vívelos en Marmot</small></h1>
						<h6 class="minisite__weather"></h6>
...
$(document).ready(function() {
  $.simpleWeather({
    location: 'Marmot Basin, Jasper, AB, Canada',
    woeid: '',
    unit: 'c',
...
<!-- marmotMinisite -->
	<div class="text-center">
    	...
    	<h2 class="red__section--title">Marmot Basin</h2>
    </div>
<!-- /marmotMinisite -->
<!-- minisiteAbout -->
	...
	<div class="container-fluid no-space">
		<div class="col-lg-6 no-space">
			<div class="minisite__about--content">
				...
				<p class="minisite__about--info">Localizado en el impresionante Parque Nacional Jasper en las Rocky Mountains de Canadá, Marmot Basin es un destino para esquí y snowboard que inspira recuerdos inolvidables. A sólo 20 minutos de la ciudad de Jasper, Marmot Basin ofrece increíbles senderos y diferentes tipos de terreno.</p>
				<p class="minisite__about--info" style="padding-top: 0;">Aquellos que ya han descubierto Marmot Basin siempre regresan por la atmósfera relajada y amigable, el increíble y variado terreno, lo accesible que es, el servicio de primera y el espectacular escenario de las Rocky Mountains.</p>
			</div>
		</div>
		<div class="col-lg-6 no-space">
			<div class="minisite__about--activities">
				...
				<ul class="list-inline minisite__about--icons">
					<li>
						<img src="images/marmot/actividades/actv1.png" alt="Actividades">
						<span>Ice skating</span>
					</li>
					<li>
						<img src="images/marmot/actividades/actv2.png" alt="Actividades">
						<span>Dog sled tours</span>
					</li>
					<li>
						<img src="images/marmot/actividades/actv3.png" alt="Actividades">
						<span>Snowshoeing</span>
					</li>
					<li>
						<img src="images/marmot/actividades/actv4.png" alt="Actividades">
...
<section class="minisite__for">
	...
	<div class="container-fluid no-space">
		<div class="col-lg-4 no-space">
			...
			<img src="images/marmot/ideal1.jpg" alt="Ideal">
		...
		<div class="col-lg-4 no-space">
			<figure class="minisite__for--item">
			<img src="images/marmot/ideal2.jpg" alt="Ideal">
				<figcaption class="minisite__for--item-name">
					<h6>Familias</h6>
				</figcaption>
			</figure>
		...
		<div class="col-lg-4 no-space">
			<figure class="minisite__for--item">
			<img src="images/marmot/ideal3.jpg" alt="Ideal">
				<figcaption class="minisite__for--item-name">
					<h6>Amigos</h6>
				</figcaption>
			</figure>
  		...
  		<div class="carousel-inner" role="listbox">
    		<div class="item active">
      		<img src="images/marmot/slideh1.jpg" alt="Carousel-item">
      			<div class="container">
	      			<div class="carousel-caption">
	        			<h2 class="minisites__hotels--name">Best Western Jasper Inn & Suites</h2>
	      			</div>
      			</div>
    		</div>
    		<div class="item">
      		<img src="images/marmot/slideh2.jpg" alt="Carousel-item">
      			<div class="container">
      				<div class="carousel-caption">
      					<h2 class="minisites__hotels--name">Chateau Jasper</h2>
      				</div>
        		</div>
    		</div>
    		<div class="item">
      		<img src="images/marmot/slideh3.jpg" alt="Carousel-item">
      			<div class="container">
      				<div class="carousel-caption">
      					<h2 class="minisites__hotels--name">Lobstich Lodge</h2>
      				</div>
        		</div>
    		</div>
    		<div class="item">
      		<img src="images/marmot/slideh4.jpg" alt="Carousel-item">
      			<div class="container">
      				<div class="carousel-caption">
      					<h2 class="minisites__hotels--name">Mount Robson Inn</h2>
      				</div>
        		</div>
    		</div>
    		<div class="item">
      		<img src="images/marmot/slideh5.jpg" alt="Carousel-item">
      			<div class="container">
      				<div class="carousel-caption">
      					<h2 class="minisites__hotels--name">Marmot Lodge</h2>
      				</div>
        		</div>
    		</div>
    	</div>
...
<!-- /minisiteMountain -->
	<div class="container-fluid no-space">
		...
		<div class="col-lg-6 no-space">
			<a href="images/marmot/info-montana.pdf" download="infoMontanaMarmot"><h5 class="minisite__mountain--download">Descargar Información de la Montaña</h5></a>
		</div>
	</div>
	...
	<div class="container-fluid">
		<div class="col-lg-3">
			<article class="minisite__resort--item">
				...
				<h6 class="minisite__resort--item-name"><a href="http://www.skimarmot.com">www.skimarmot.com</a></h6>
			</article>
		</div>
		<div class="col-lg-3">
			<article class="minisite__resort--item">
				...
				<h6 class="minisite__resort--item-name">Marmot Basin Box 1300 <br> Jasper, Alberta, Canada T0E 1E0</h6>
			</article>
		</div>
		<div class="col-lg-3">
			<article class="minisite__resort--item">
				...
				<h6 class="minisite__resort--item-name">Phone: <br>1-866-952-3816</h6>
			</article>
		</div>
		<div class="col-lg-3">
			<article class="minisite__resort--item">
				...
				<h6 class="minisite__resort--item-name">--</h6>
			</article>
		</div>
	</div>
