  ...
  <body>
       ...
       <div class="container-fluid no-space">
            <div class="col-lg-3 col-md-3 col-xs-6 no-space">
                <div class="header__logo">
                    <a href="http://www.skihouse.com.mx/index.php"><img src="/images/logo.png" alt="Skihouse"></a>
                </div>
           </div>
           <div class="col-lg-9 col-md-9 col-xs-6 no-space">
               <div class="header__social">
                   <ul class="header__social--media list-inline">
                       <li><span class="header__info">Tel. (55) 55457761 |  (55) 52504201</span></li>
                       <li><a href="http://www.skihouse.com.mx/pagos.php"><span class="header__info">Realizar pago <img src="/images/ic1.png" class="header__icon--payment" alt="Realizar pago"></span></a></li>
   ...
   <nav class="navigation" id="nav">
       <ul class="navigation__list">
           <li><a href="http://www.skihouse.com.mx/index.php">Home</a></li>
           <li><a href="http://www.skihouse.com.mx/somos.php">Somos</a></li>
           <li><a href="http://www.skihouse.com.mx/destinos.php">Destinos</a></li>
           <li><a href="http://www.skihouse.com.mx/servicios.php">Servicios</a></li>
           <li><a href="http://www.skihouse.com.mx/promociones.php">Promos</a></li>
           <li><a href="http://www.skihouse.com.mx/pagos.php">Formas de Pago</a></li>
           <li><a href="http://blog.skihouse.com.mx">Blog</a></li>
           <li><a href="http://www.skihouse.com.mx/contacto.php">Contacto</a></li>
       </ul>
       <div class="visible-xs visible-sm navigation__mobile">
       <span class="mobile__payment"><a href="http://www.skihouse.com.mx/pagos.php">Realizar pago <img src="/images/ic1.png" class="header__icon--payment" alt="Realizar pago"></a></span>
